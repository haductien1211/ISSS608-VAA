...
In this section, you will learn how to plot static parallel coordinates plot by using `ggparcoord()` of [GGally](https://ggobi.github.io/ggally/reference/ggparcoord.html) package. Before getting started, it is a good practice to read the function description in detail.
...
-   `ggparcoord()` of [GGally](https://ggobi.github.io/ggally/reference/ggparcoord.html) package

-   [parcoords](https://www.rdocumentation.org/packages/MASS/versions/7.3-60.0.1/topics/parcoord) user guide
