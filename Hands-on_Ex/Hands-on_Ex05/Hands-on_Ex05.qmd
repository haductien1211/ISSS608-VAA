...
In this exercise, we will learn how to visualise and analyse text data using R.
...
In this code chunk below, `wordcloud()` of [wordcloud](https://blog.fellstat.com/?cat=11) package is used to plot a static wordcloud.
